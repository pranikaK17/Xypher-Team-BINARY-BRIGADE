...
export default function TeacherDashboard() {
  ...
  const students = {
    ...
    C: [
      { id: 21, name: "Advait Rao", submitted: true, grade: 81, history: [78, 83, 79, 81] },
      { id: 22, name: "Prisha Iyer", submitted: true, grade: 93, history: [90, 95, 91, 93] },
      { id: 23, name: "Atharv Desai", submitted: false, grade: null, history: [73, 76, 71] },
      { id: 24, name: "Ira Chandra", submitted: true, grade: 88, history: [85, 90, 86, 88] },
      { id: 25, name: "Rudra Jain", submitted: true, grade: 76, history: [72, 78, 74, 76] },
      { id: 26, name: "Tara Bose", submitted: true, grade: 92, history: [89, 94, 90, 92] },
      { id: 27, name: "Kabir Ghosh", submitted: false, grade: null, history: [68, 71, 66] },
      { id: 28, name: "Anika Dutta", submitted: true, grade: 84, history: [81, 86, 82, 84] },
      { id: 29, name: "Shivansh Roy", submitted: true, grade: 87, history: [84, 89, 85, 87] },
      { id: 30, name: "Mira Chakraborty", submitted: true, grade: 90, history: [87, 92, 88, 90] },
    ],
    D: [
      { id: 31, name: "Aryan Khanna", submitted: true, grade: 89, history: [86, 91, 87, 89] },
      { id: 32, name: "Zara Shah", submitted: true, grade: 85, history: [82, 87, 83, 85] },
      { id: 33, name: "Dhruv Bajaj", submitted: true, grade: 77, history: [74, 79, 75, 77] },
      { id: 34, name: "Nisha Goyal", submitted: false, grade: null, history: [70, 73, 69] },
      { id: 35, name: "Karan Sethi", submitted: true, grade: 91, history: [88, 93, 89, 91] },
      { id: 36, name: "Priya Chopra", submitted: true, grade: 86, history: [83, 88, 84, 86] },
      { id: 37, name: "Yash Arora", submitted: false, grade: null, history: [65, 68, 63] },
      { id: 38, name: "Rhea Mittal", submitted: true, grade: 94, history: [91, 96, 92, 94] },
      { id: 39, name: "Arnav Goel", submitted: true, grade: 82, history: [79, 84, 80, 82] },
      { id: 40, name: "Tanvi Aggarwal", submitted: true, grade: 88, history: [85, 90, 86, 88] },
    ],
    E: [
      { id: 41, name: "Veer Thakur", submitted: true, grade: 92, history: [89, 94, 90, 92] },
      { id: 42, name: "Vaani Khurana", submitted: true, grade: 87, history: [84, 89, 85, 87] },
      { id: 43, name: "Shaurya Bhatia", submitted: true, grade: 83, history: [80, 85, 81, 83] },
      { id: 44, name: "Aarohi Jindal", submitted: false, grade: null, history: [76, 79, 74] },
      { id: 45, name: "Ranveer Kohli", submitted: true, grade: 95, history: [92, 97, 93, 95] },
      { id: 46, name: "Shanaya Vohra", submitted: true, grade: 89, history: [86, 91, 87, 89] },
      { id: 47, name: "Aarav Singhal", submitted: true, grade: 81, history: [78, 83, 79, 81] },
      { id: 48, name: "Bhavya Rastogi", submitted: false, grade: null, history: [72, 75, 70] },
      { id: 49, name: "Kartik Sood", submitted: true, grade: 90, history: [87, 92, 88, 90] },
      { id: 50, name: "Disha Kaul", submitted: true, grade: 86, history: [83, 88, 84, 86] },
    ],
    F: [
      { id: 51, name: "Eshan Bhardwaj", submitted: true, grade: 84, history: [81, 86, 82, 84] },
      { id: 52, name: "Fatima Khan", submitted: true, grade: 88, history: [85, 90, 86, 88] },
      { id: 53, name: "Gaurav Sachdeva", submitted: false, grade: null, history: [67, 70, 65] },
      { id: 54, name: "Hiya Mahajan", submitted: true, grade: 91, history: [88, 93, 89, 91] },
      { id: 55, name: "Ishan Gulati", submitted: true, grade: 79, history: [76, 81, 77, 79] },
      { id: 56, name: "Jiya Oberoi", submitted: true, grade: 93, history: [90, 95, 91, 93] },
      { id: 57, name: "Kshitij Wadhwa", submitted: true, grade: 85, history: [82, 87, 83, 85] },
      { id: 58, name: "Lavanya Talwar", submitted: false, grade: null, history: [71, 74, 69] },
      { id: 59, name: "Manav Chadha", submitted: true, grade: 87, history: [84, 89, 85, 87] },
      { id: 60, name: "Nitya Kalra", submitted: true, grade: 82, history: [79, 84, 80, 82] },
    ],
  }
